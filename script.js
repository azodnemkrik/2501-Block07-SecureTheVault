/*
Pseudocode:
1. Create a "vault" feel in HTML & CSS
2. Set up appropriate variables in JS
3. Create message(s) that will be displayed to the user
4. Enhance the project by adding a little functionality vs. just displaying the message upon loading the page. I will add 2 buttons that will allow the user to either see the combination or opt out of the vault mission.
*/


// Declare the 3 code numbers to be used for the Combination
